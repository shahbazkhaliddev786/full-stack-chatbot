    ...
    <>
      <form onSubmit={handlePrompt} className="mt-5">
        ...
        <button
          ...
          className="text-white absolute right-6 bottom-[3rem] bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
        >
          <FaArrowUp />
        </button>
      </form>
